...
## ⚡ Making `dnf` faster <a name="making-dnf-faster"></a>
...
## 🗄️ Setting up some repositories <a name="setting-up-some-repositories"></a>
...
### 🌐 RPM Fusion <a name="rpm-fusion"></a>
...
### 🔊 Multimedia Codecs <a name="multimedia-codecs"></a>
...
### 💻 Hardware Codecs <a name="hardware-codecs"></a>
...
### 🥡 AppImages <a name="appimages"></a>

#### 🧰 JetBrains Toolbox <a name="jetbrains-toolbox"></a>
...
That’s probably the most important part for me because I use it for many kinds of important things like editing files and running fetches. The advantage of the shell is everything can be done with commands in the terminal (most if not all GUI things too, but not as easy).

Install [starship](https://starship.rs) to have an easy customizable prompt for pretty much all shells. On Fedora, there is a copr available to keep starship up to date.
...
wget -qOhttps://git.io/papirus-folders-install | sh
...
Extensions are a big part for me when using GNOME. The following list will contain the extensions I always install and use. I won’t write up how I set them up because I’m too lazy and most of that is visible in the Screenshots.
...
### 🕵️‍♂️ Ulauncher <a name="ulauncher"></a>
