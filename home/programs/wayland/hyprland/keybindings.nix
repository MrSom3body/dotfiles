  ...
  wayland.windowManager.hyprland.settings = {
    ...
    in
      [
        ...
        # Screenshots
        ", PRINT, Take screenshot of screen, exec, grimblast --notify copysave screen"
        "$mainMod, PRINT, Take screenshot of window, exec, grimblast --notify copysave active"
        "SHIFT, PRINT, Take screenshot of area, exec, grimblast --notify copysave area"
