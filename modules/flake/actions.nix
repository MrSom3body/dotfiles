...
let
  ...
  actions = {
    ...
    action-gh-release = "softprops/action-gh-release@3bb12739c298aeb8a4eeaf626c5b8d85266b0e65"; # v2.6.2
    ...
    create-github-app-token = "actions/create-github-app-token@1b10c78c7865c340bc4f6099eb2f838309f1e8c3"; # v3.1.1
  };
