    ...
    in
    {
      ...
      config.wayland.windowManager.hyprland.settings = {
        ...
        ++ lib.optionals (layout == "scrolling") [
          ...
          # Move window/column (Mod+Ctrl in niri)
          ...
          # Consume/expel windows (Mod+BracketLeft/Right in niri)
          "SUPER, BracketRight, Expel window from column, layoutmsg, promote"
          "SUPER, Period, Expel window from column, layoutmsg, promote"

          # Cycle preset column widths (Mod+R in niri)
          ...
          # Center focused column (Mod+C in niri)
